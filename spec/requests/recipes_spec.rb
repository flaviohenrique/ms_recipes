    ...
    let(:recipe_attrs) do
      {
        ...
        description: 'Crispy chicken skin, tender meat, and rich, tomatoey sauce form a winning trifecta '\
                     'of delicious in this one-pot braise. We spoon it over rice and peas to soak up every last drop '\
                     'of goodness, and serve a tangy arugula salad alongside for a vibrant boost of flavor and color. '\
                     'Dinner is served! Cook, relax, and enjoy!',
        image_url: '//images.ctfassets.net/kk2bw5ojx476/5mFyTozvSoyE0Mqseoos86/fb88f4302cfd184492e548cde11a2555'\
                   '/SKU1479_Hero_077-71d8a07ff8e79abcb0e6c0ebf0f3b69c.jpg?w=300&h=300&q=100',
